    ...
    <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-sm">
      <div className="container flex h-16 items-center justify-center px-4 md:px-6 relative">
        <Link href="/" className="flex items-center gap-2" prefetch={false}>
          {/* Logo redonda com fundo branco */}
          <div className="relative w-16 h-16 rounded-full bg-white flex items-center justify-center overflow-hidden">
            <Image
              src="/images/1_10GPAV.png"
              alt="Squadron Logo"
              width={60} // Ajuste o tamanho da imagem para caber no círculo
              height={60}
              className="object-contain"
            />
          </div>
          <div className="flex flex-col">
            {/* Título do esquadrão com fonte maior no desktop */}
            <span className="text-lg md:text-xl font-semibold text-red-600">1º/10º GAV - ESQUADRÃO POKER</span>
